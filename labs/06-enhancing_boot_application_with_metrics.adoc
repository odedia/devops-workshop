...
+
curl http://localhost:8080/actuator/autoconfig
+
-> Displays all of the auto-configuration performed as part of application bootstrapping.
+
...
+
-> Performs a thread dump. You can import this file into a JVM profiler such as JProfiler.
+
